...
const DetailProduct = () => {
    ...
    useEffect(()=>{
            async function getData(){
                let response = await axios.get(`https://apitaipham.herokuapp.com/getdata/${id}`)
                        ...
                        <div className="wrapper row">
                            <div className="preview col-md-6">
                                ...
                                <ul className="preview-thumbnail nav nav-tabs">
                                    <li className="active"><a data-target="#pic-1" data-toggle="tab"><img src="http://placekitten.com/200/126" alt=""/></a></li>
                                    <li><a data-target="#pic-2" data-toggle="tab"><img src="http://placekitten.com/200/126" alt=""/></a></li>
                                    <li><a data-target="#pic-3" data-toggle="tab"><img src="http://placekitten.com/200/126" alt=""/></a></li>
                                    <li><a data-target="#pic-4" data-toggle="tab"><img src="http://placekitten.com/200/126" alt=""/></a></li>
